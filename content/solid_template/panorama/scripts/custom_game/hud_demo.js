...
const EOM_DebugTool = props => {
  ...
  return (() => {
    ...
    libs.insert(_el$1, libs.createComponent(EOM_Icon, {
      type: "ArrowRight",
      width: "8px",
      height: "14px",
      align: "center center",
...
function EOM_DebugTool_Setting() {
  ...
  const [demoSetting, _setDemoSetting2] = libs.createSignal(CustomNetTables.GetTableValue("common", "demo_settings"));
  const defaultSettingList = ["ReloadScriptButtonPressed"];
  const RegisterDemoButton = (key, eventName, bInit) => {
    return;
  };
  const RegisterHotkey = eventName => {
  ...
  return libs.createComponent(SelectionContainer, {
    ...
    get children() {
      ...
      libs.setProp(_el$12, "marginTop", "12px");
      libs.setProp(_el$12, "onload", self => OnLoad(self));
      libs.insert(_el$12, libs.createComponent(SettingToggleButton, {
        get selected() {
          return playerConfig()["alt_tool"];
        },
        settingName: "alt_tool",
        text: "ALT切换调试工具"
      }), null);
      libs.insert(_el$12, libs.createComponent(libs.For, {
        each: defaultSettingList,
        children: (eventName, index) => {
          const hotkey = () => playerConfig()[eventName];
          return libs.createComponent(EOM_KeyBinder, {
            get text() {
              return buttonTextList()[eventNameList().indexOf(eventName)];
            },
            get initKey() {
              return hotkey();
            },
      ...
      libs.insert(_el$12, libs.createComponent(libs.For, {
        get each() {
          return Object.keys(playerConfig());
        },
        children: (eventName, index) => {
          if (eventName.indexOf("hotkey_") != -1 && defaultSettingList.indexOf(eventName.replace("hotkey_", "")) == -1) {
            return (() => {
              ...
              libs.insert(_el$13, libs.createComponent(EOM_KeyBinder, {
                ...
                get initDropIndex() {
                  return eventNameList().indexOf(eventName.replace("hotkey_", "")) + 1;
                },
                get initKey() {
                  return playerConfig()[eventName];
                },
                onChange: (key, init) => {
                  if (!init) {
                    SaveConfig(eventName, key);
      ...
      libs.insert(_el$12, () => [...Array(customKeyBindCount)].map((_, index) => {
        if (buttonTextList.length > 0) {
          return (() => {
            ...
            libs.insert(_el$15, libs.createComponent(EOM_Button.EOM_IconButton, {
              verticalAlign: "center",
              get icon() {
                return libs.createElement("Image", {
                  src: "s2r://panorama/images/control_icons/x_close_png.vtex"
            ...
            libs.insert(_el$15, libs.createComponent(EOM_KeyBinder, {
              get text() {
                return buttonTextList();
              },
...
const SettingToggleButton = props => {
  ...
  return (() => {
    const _el$17 = libs.createElement("Button", {
        get ["class"]() {
          return libs.classNames("ToggleButton SettingToggleButton", {
            selected: selected()
          });
        }
      }, null);
    ...
    libs.setProp(_el$17, "onactivate", self => {
      setSelected(!selected());
      SaveConfig(props.settingName, props.selected ? "FALSE" : "TRUE");
    });
    libs.setProp(_el$17, "tooltip_text", tooltip == "" ? undefined : tooltip);
    libs.effect(_p$ => {
      const _v$3 = libs.classNames("ToggleButton SettingToggleButton", {
          selected: selected()
        }),
        _v$4 = props.text;
...
const DemoButton = props => {
  ...
  return (() => {
    ...
    libs.setProp(_el$27, "onactivate", onactivate);
    libs.effect(_p$ => {
  ...
  return (() => {
    ...
    libs.effect(_p$ => {
      const _v$0 = props.eventName,
        _v$1 = props.text;
      _v$0 !== _p$._v$0 && (_p$._v$0 = libs.setProp(_el$28, "id", _v$0, _p$._v$0));
...
const DemoTextEntry = props => {
  return (() => {
    const _el$29 = libs.createElement("TextButton", {
      ...
      _el$30 = libs.createElement("TextEntry", {
        id: "DemoTextEntry",
        get text() {
    ...
    libs.setProp(_el$30, "onload", self => {
      self.SetDisableFocusOnMouseDown(false);
    });
    libs.setProp(_el$30, "oninputsubmit", self => {
    ...
    libs.setProp(_el$30, "oncancel", self => {
      $.DispatchEvent("DropInputFocus", self);
    });
    libs.effect(_p$ => {
      const _v$10 = props.text,
        _v$11 = props.defaultValue;
      _v$10 !== _p$._v$10 && (_p$._v$10 = libs.setProp(_el$29, "text", _v$10, _p$._v$10));
      _v$11 !== _p$._v$11 && (_p$._v$11 = libs.setProp(_el$30, "text", _v$11, _p$._v$11));
      return _p$;
    }, {
      _v$10: undefined,
      _v$11: undefined
...
const DemoSelectionButton = props => {
  return (() => {
    const _el$36 = libs.createElement("TextButton", {
      get id() {
        return props.eventName;
      },
    ...
    libs.insert(_el$36, libs.createComponent(EOM_Icon, {
    ...
    libs.effect(_p$ => {
      const _v$15 = props.eventName,
        _v$16 = props.text;
      _v$15 !== _p$._v$15 && (_p$._v$15 = libs.setProp(_el$36, "id", _v$15, _p$._v$15));
      _v$16 !== _p$._v$16 && (_p$._v$16 = libs.setProp(_el$36, "text", _v$16, _p$._v$16));
      return _p$;
    }, {
      _v$15: undefined,
      _v$16: undefined
  ...
  return (() => {
    ...
    libs.insert(_el$39, (() => {
      ...
      return () => _c$() && (() => {
              ...
              get children() {
                return [libs.createElement("Label", {
                  ...
                  children: (key, index) => (() => {
                    ...
                    libs.effect(_$p => libs.setProp(_el$46, "text", local.toggleList?.[key] ?? "", _$p));
                    return _el$46;
                  })()
                })];
              }
        ...
        libs.setProp(_el$45, "onload", self => {
          self.SetDisableFocusOnMouseDown(false);
        });
        libs.setProp(_el$45, "oninputsubmit", self => {
          if (local.onSearch) {
            local.onSearch(self.text);
          }
        });
        libs.setProp(_el$45, "ontextentrychange", self => {
          if (self.text == "") {
            if (local.onSearch) {
              local.onSearch("");
            }
    ...
    libs.insert(_el$39, libs.createComponent(EOM_Button.EOM_IconButton, {
      width: "28px",
      verticalAlign: "center",
      tooltip: "关闭窗口",
      tooltipPosition: "top",
    ...
    libs.insert(_el$42, () => props.children);
    libs.effect(_p$ => {
...
const EOM_UnitInfo = props => {
  ...
  return libs.createComponent(SelectionContainer, {
    ...
    get children() {
      ...
      libs.insert(_el$63, libs.createComponent(EOM_UnitInfoRow, {
        key: "实体ID",
        get value() {
      ...
      libs.insert(_el$63, libs.createComponent(EOM_UnitInfoRow, {
        key: "物理输出",
        get value() {
          return `${unitInfo.outgoingPhysical} (+${unitInfo.physicalPerMin}%每分钟)`;
        },
        eventType: "Add",
        eventName: "UnitInfoPhysicalDamage"
      }), null);
      libs.insert(_el$63, libs.createComponent(EOM_UnitInfoRow, {
        key: "魔法输出",
        get value() {
          return `${unitInfo.outgoingMagical} (+${unitInfo.physicalPerMin}%每分钟)`;
        },
        eventType: "Add",
        eventName: "UnitInfoMagicalDamage"
      }), null);
      libs.insert(_el$63, libs.createComponent(EOM_UnitInfoRow, {
        key: "暴击率",
        get value() {
      ...
      libs.insert(_el$63, libs.createComponent(EOM_UnitInfoRow, {
        key: "暴击伤害",
        get value() {
          return `${unitInfo.critDamage} (+${unitInfo.critDamagePerMin}%每分钟)`;
        },
      ...
      libs.insert(_el$63, libs.createComponent(EOM_UnitInfoRow, {
        key: "护甲",
        get value() {
          return unitInfo.armor;
        },
        eventType: "Add",
        eventName: "UnitInfoArmor"
      }), null);
      libs.insert(_el$63, libs.createComponent(EOM_UnitInfoRow, {
        key: "受到伤害",
        get value() {
          return unitInfo.reducePct;
        }
      }), null);
      libs.insert(_el$63, libs.createComponent(EOM_UnitInfoRow, {
        key: "移速",
      ...
      libs.insert(_el$63, libs.createComponent(EOM_UnitInfoRow, {
        key: "冷却缩减",
        get value() {
          return unitInfo.cooldown;
        },
        eventType: "Add",
        eventName: "UnitInfoCooldownReduction"
      }), null);
      libs.insert(_el$63, libs.createComponent(EOM_UnitInfoRow, {
        key: "碰撞体积",
        get value() {
          return unitInfo.hullRadius;
        }
      }), null);
      libs.insert(_el$63, libs.createComponent(EOM_UnitInfoRow, {
        key: "视野",
        get value() {
          return unitInfo.vision;
        }
      }), null);
      libs.insert(_el$63, libs.createComponent(libs.Show, {
        get when() {
          return unitInfo.isHero;
        },
        get children() {
          return [libs.createComponent(EOM_UnitInfoRow, {
            key: "力量",
            get value() {
              return unitInfo.str;
            },
            eventType: "Add",
            eventName: "UnitInfoStrength"
          }), libs.createComponent(EOM_UnitInfoRow, {
            key: "敏捷",
            get value() {
              return unitInfo.agi;
            },
            eventType: "Add",
            eventName: "UnitInfoAgility"
          }), libs.createComponent(EOM_UnitInfoRow, {
            key: "智力",
            get value() {
              return unitInfo.int;
            ...
            eventType: "Add",
            eventName: "UnitInfoIntellect"
          }), libs.createComponent(EOM_UnitInfoRow, {
            key: "吸血概率",
            get value() {
              return unitInfo.lifesteal;
            }
          }), libs.createComponent(EOM_UnitInfoRow, {
            key: "物理吸血",
            get value() {
              return unitInfo.phylifesteal;
            }
          }), libs.createComponent(EOM_UnitInfoRow, {
            key: "魔法吸血",
            get value() {
              return unitInfo.maglifesteal;
            }
          }), libs.createComponent(EOM_UnitInfoRow, {
            key: "金币百分比",
            get value() {
              return unitInfo.goldPct;
            }
          }), libs.createComponent(EOM_UnitInfoRow, {
            key: "荣耀百分比",
            get value() {
              return unitInfo.scorePct;
            }
          }), libs.createComponent(EOM_UnitInfoRow, {
            key: "复活时间",
            get value() {
              return unitInfo.respawn;
            }
          }), libs.createComponent(EOM_UnitInfoRow, {
            key: "攻击成长",
            get value() {
              return `击杀：${unitInfo.AttackPerKill} | 每秒：${unitInfo.AttackPerSec} | 攻击：${unitInfo.AttackPerAttack}`;
            }
          }), libs.createComponent(EOM_UnitInfoRow, {
            key: "法强成长",
            get value() {
              return `击杀：${unitInfo.PowerPerKill} | 每秒：${unitInfo.PowerPerSec} | 攻击：${unitInfo.PowerPerAttack}`;
            }
          }), libs.createComponent(EOM_UnitInfoRow, {
            key: "生命成长",
            get value() {
              return `击杀：${unitInfo.HealthPerKill} | 每秒：${unitInfo.HealthPerSec} | 攻击：${unitInfo.HealthPerAttack}`;
            }
          }), libs.createComponent(EOM_UnitInfoRow, {
            key: "力量成长",
            get value() {
              return `击杀：${unitInfo.StrPerKill} | 每秒：${unitInfo.StrPerSec} | 攻击：${unitInfo.StrPerAttack}`;
            }
          }), libs.createComponent(EOM_UnitInfoRow, {
            key: "敏捷成长",
            get value() {
              return `击杀：${unitInfo.AgiPerKill} | 每秒：${unitInfo.AgiPerSec} | 攻击：${unitInfo.AgiPerAttack}`;
            }
          }), libs.createComponent(EOM_UnitInfoRow, {
            key: "智力成长",
            get value() {
              return `击杀：${unitInfo.IntPerKill} | 每秒：${unitInfo.IntPerSec} | 攻击：${unitInfo.IntPerAttack}`;
            }
          }), libs.createComponent(EOM_UnitInfoRow, {
            key: "召唤伤害",
            get value() {
              return unitInfo.summonPct;
            }
          }), libs.createComponent(EOM_UnitInfoRow, {
            key: "金币怪数量",
            get value() {
              return unitInfo.monster;
            }
          }), libs.createComponent(EOM_UnitInfoRow, {
            key: "掉落幸运",
            get value() {
              return unitInfo.dropLucky;
            }
          }), libs.createComponent(EOM_UnitInfoRow, {
            key: "稀有度幸运",
            get value() {
              return unitInfo.rarityLucky;
            }
          })];
        }
      }), null);
          ...
          if (abilityIndex != -1) {
            ...
            return (() => {
              const _el$71 = libs.createElement("Panel", {
                ...
                _el$73 = libs.createElement("DOTAAbilityImage", {
                  id: "Drag" + abilityName,
                  "class": "DOTAAbilityImage",
                  abilityname: abilityName,
                  showtooltip: false
                }, _el$72),
                _el$74 = libs.createElement("Button", {
                  "class": "AbilityActionButton DemoButton GreenButton"
                }, _el$71);
                libs.createElement("Label", {
                  text: "升级"
                }, _el$74);
                const _el$76 = libs.createElement("Button", {
                  "class": "AbilityActionButton DemoButton RedButton"
                }, _el$71);
                libs.createElement("Label", {
                  text: "删除"
                }, _el$76);
              libs.setProp(_el$72, "id", "Drag" + abilityName);
              libs.setProp(_el$72, "onDragStart", onDragStart);
              libs.setProp(_el$72, "onDragDrop", onDragDrop);
              libs.setProp(_el$72, "onDragEnd", onDragEnd);
              libs.setProp(_el$73, "id", "Drag" + abilityName);
              libs.setProp(_el$73, "abilityname", abilityName);
              libs.setProp(_el$73, "onmouseover", p => CustomUIConfig.ShowAbilityTooltip(p, {
                abilityentityindex: abilityentityindex
              }));
              libs.setProp(_el$73, "onmouseout", p => CustomUIConfig.HideAbilityTooltip(p));
              libs.setProp(_el$74, "onactivate", self => FireEvent("UnitInfoUpgradeAbility", String(abilityIndex)));
              libs.setProp(_el$76, "onactivate", self => FireEvent("UnitInfoRemoveAbility", String(abilityIndex)));
              return _el$71;
            })();
          }
        }
      }));
      libs.insert(_el$70, libs.createComponent(libs.For, {
        get each() {
          return unitInfo.devouredList;
        },
          ...
          if (itemIndex != -1) {
            ...
            return (() => {
              const _el$78 = libs.createElement("Panel", {
                  "class": "DevouredItemActionPanel"
                }, null),
                _el$79 = libs.createElement("DOTAItemImage", {
                  id: "Drag" + abilityName,
                  itemname: abilityName,
                  showtooltip: false
                }, _el$78),
                _el$80 = libs.createElement("Button", {
                  "class": "DevouredItemActionButton DemoButton GreenButton"
                }, _el$78);
                libs.createElement("Label", {
                  text: "吐出"
                }, _el$80);
                const _el$82 = libs.createElement("Button", {
                  "class": "DevouredItemActionButton DemoButton RedButton"
                }, _el$78);
                libs.createElement("Label", {
                  text: "删除"
                }, _el$82);
              libs.setProp(_el$79, "id", "Drag" + abilityName);
              libs.setProp(_el$79, "itemname", abilityName);
              libs.setProp(_el$79, "onmouseover", p => CustomUIConfig.ShowAbilityTooltip(p, {
                abilityentityindex: abilityentityindex,
                entityindex: unitInfo.entIndex
              }));
              libs.setProp(_el$79, "onmouseout", p => CustomUIConfig.HideAbilityTooltip(p));
              libs.setProp(_el$80, "onactivate", self => FireEvent("UnitInfoReleaseDevouredItem", String(itemIndex)));
              libs.setProp(_el$82, "onactivate", self => FireEvent("UnitInfoRemoveDevouredItem", String(itemIndex)));
              return _el$78;
            })();
          }
        }
      ...
      libs.effect(_p$ => {
        ...
        _v$26 !== _p$._v$26 && (_p$._v$26 = libs.setProp(_el$63, "classList", _v$26, _p$._v$26));
        _v$27 !== _p$._v$27 && (_p$._v$27 = libs.setProp(_el$64, "classList", _v$27, _p$._v$27));
        _v$28 !== _p$._v$28 && (_p$._v$28 = libs.setProp(_el$69, "classList", _v$28, _p$._v$28));
        _v$29 !== _p$._v$29 && (_p$._v$29 = libs.setProp(_el$70, "classList", _v$29, _p$._v$29));
        return _p$;
      }, {
        _v$26: undefined,
        _v$27: undefined,
...
const EOM_UnitInfoRow = props => {
  ...
  return (() => {
    const _el$84 = libs.createElement("Panel", {
      ...
      _el$87 = libs.createElement("Image", {
        "class": "EOM_UnitInfoEdit"
      }, _el$84);
    const _ref$2 = label;
    typeof _ref$2 === "function" ? libs.use(_ref$2, _el$86) : label = _el$86;
    libs.insert(_el$84, libs.createComponent(EOM_TextEntry, {
      ref(r$) {
        const _ref$3 = entry;
    ...
    libs.setProp(_el$87, "onactivate", self => {
    ...
    libs.effect(_p$ => {
      ...
      _v$30 !== _p$._v$30 && (_p$._v$30 = libs.setProp(_el$84, "classList", _v$30, _p$._v$30));
      _v$31 !== _p$._v$31 && (_p$._v$31 = libs.setProp(_el$85, "text", _v$31, _p$._v$31));
      _v$32 !== _p$._v$32 && (_p$._v$32 = libs.setProp(_el$86, "visible", _v$32, _p$._v$32));
      _v$33 !== _p$._v$33 && (_p$._v$33 = libs.setProp(_el$86, "text", _v$33, _p$._v$33));
      _v$34 !== _p$._v$34 && (_p$._v$34 = libs.setProp(_el$87, "classList", _v$34, _p$._v$34));
      return _p$;
    }, {
      _v$30: undefined,
      _v$31: undefined,
...
const EOM_UnitInfoModifierRow = props => {
  return (() => {
    const _el$88 = libs.createElement("Panel", {
      ...
      _el$92 = libs.createElement("Button", {
        "class": "ModifierActionButton DemoButton GreenButton"
      }, _el$91);
      libs.createElement("Label", {
        text: "刷新"
      }, _el$92);
      const _el$94 = libs.createElement("Button", {
        "class": "ModifierActionButton DemoButton RedButton"
      }, _el$91);
      libs.createElement("Label", {
        text: "移除"
      }, _el$94);
    libs.setProp(_el$92, "onactivate", self => FireEvent("UnitInfoRefreshModifier", props.name));
    libs.setProp(_el$94, "onactivate", self => FireEvent("UnitInfoRemoveModifier", props.name));
    libs.effect(_p$ => {
      const _v$35 = props.name,
        _v$36 = props.name,
        _v$37 = props.count;
      _v$35 !== _p$._v$35 && (_p$._v$35 = libs.setProp(_el$88, "tooltip_text", _v$35, _p$._v$35));
      _v$36 !== _p$._v$36 && (_p$._v$36 = libs.setProp(_el$89, "text", _v$36, _p$._v$36));
      _v$37 !== _p$._v$37 && (_p$._v$37 = libs.setProp(_el$90, "text", _v$37, _p$._v$37));
      return _p$;
    }, {
      _v$35: undefined,
      _v$36: undefined,
...
const EOM_DebugTool_AbilityPicker = props => {
  ...
  const [toggleType, setToggleType] = libs.createSignal("");
  const [rawMode, setRawMode] = libs.createSignal(false);
  const [rarity, setRarity] = libs.createSignal("ALL");
  const visible = abilityname => {
    if (local.filterFunc) {
    ...
    if (filterWord() != "") {
      ...
      if (abilityname.search(reg) == -1 && localized.search(new RegExp(filterWord(), "gim")) == -1 && !Pinyin.test(reg, localized)) {
        return false;
      }
    }
    return true;
      ...
      libs.insert(_el$2, libs.createComponent(libs.For, {
        ...
        children: (abilityname, index) => {
          return libs.createComponent(EOM_Button.EOM_BaseButton, {
            ...
            onmouseover: p => CustomUIConfig.ShowAbilityTooltip(p, {
              abilityname: abilityname,
              onlycurrentlevelvalue: false
            }),
...
const EOM_DebugTool_ItemPicker = props => {
  ...
  const visiable = abilityname => {
    ...
    if (filterWord() != "") {
      ...
      let localized = GetLocalization("#DOTA_Tooltip_ability_" + abilityname);
      if (abilityname.search(regExp) != -1 || localized.search(regExp) != -1 || GetLocalization("#DOTA_Tooltip_ability_" + abilityname + "_Description", "").search(regExp) != -1 || Pinyin.test(regExp, localized)) {
        return true;
      }
        ...
        children: (abilityname, index) => libs.createComponent(EOM_Button.EOM_BaseButton, {
          ...
          get children() {
            return [(() => {
              ...
              libs.setProp(_el$3, "itemname", abilityname);
              return _el$3;
            })(), (() => {
              const _el$4 = libs.createElement("Label", {
                get text() {
...
function Demo() {
  ...
  const abilityFilter = (toggleType, itemName) => {
    if (toggleType == "") return true;
  ...
  const unitFilter = (toggleType, itemName) => {
    if (toggleType == "") return true;
  ...
  const [abilityList, setAbilityList] = libs.createSignal(getAbilityList());
  const [itemList, setItemList] = libs.createSignal(getItemList());
  const [unitList, setUnitList] = libs.createSignal(getUnitList());
          ...
          return [libs.createComponent(EOM_DebugTool_Category, {
            ...
            get children() {
              return [libs.createComponent(DemoSelectionButton, {
                ...
                eventName: "RemoveGroundItemsPressed",
                text: "删除地上物品"
              })];
            }
          }), libs.createComponent(EOM_DebugTool_Category, {
