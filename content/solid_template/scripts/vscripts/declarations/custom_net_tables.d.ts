...
declare interface PlayerDataType {
	...
	mark_equip: Record<string, string>;
	mark_ability: Record<string, string>;
}
...
interface NetDataDeclarations {
	...
	player_warning: {
		too_much_equipment_common?: boolean;
		too_much_equipment_gene?: boolean;
		too_much_gem?: boolean;
		too_much_artifact?: boolean;
		too_much_artifact_ticket?: boolean;
	};
}
