...
interface PropertyDebugInfo {
	...
	key: PropertyKey;
	totalValue: number;
	staticContributions: Array<{ modifierName: string; value: number; addedTime: number; }>;
	dynamicContributions: Array<{ modifierName: string; value: number; priority: number; addedTime: number; }>;
	cacheStatus: { enabled: boolean; cached: boolean; frame?: number; age?: number; };
}
