...
function CTimer.prototype.Think(self)
    ...
    for i = #keys, 1, -1 do
        do
            ...
            if timerData.entity ~= nil and not IsValid(timerData.entity) then
