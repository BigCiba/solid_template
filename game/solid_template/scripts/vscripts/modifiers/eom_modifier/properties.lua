...
EOM_UPDATE_HEALTH_PROPERTY = {[EOMModifierFunction.EOM_MODIFIER_PROPERTY_HEALTH] = true, [EOMModifierFunction.EOM_MODIFIER_PROPERTY_HEALTH_STATS] = true, [EOMModifierFunction.EOM_MODIFIER_PROPERTY_HEALTH_PERCENTAGE] = true, [EOMModifierFunction.EOM_MODIFIER_PROPERTY_HEALTH_PERCENTAGE_MULTIPLE] = true}
EOM_UPDATE_MANA_PROPERTY = {[EOMModifierFunction.EOM_MODIFIER_PROPERTY_MANA] = true, [EOMModifierFunction.EOM_MODIFIER_PROPERTY_MANA_STATS] = true, [EOMModifierFunction.EOM_MODIFIER_PROPERTY_MANA_PERCENTAGE] = true}
